...
BTN_TMPL = (
    ...
    '<xdr:txBody><a:bodyPr vertOverflow="clip" horzOverflow="clip" anchor="ctr"/>'
...
def start_buttons():
    """Start! sheet: 4 stacked buttons in column E (old button position)."""
    btns = []
    rows = [(6, 180975, 8, 104775),
            (9, 180975, 11, 104775),
            (12, 180975, 14, 104775),
            (15, 180975, 17, 104775)]
    spec = [("BtnSettings", "初期設定", "4472C4", "2F528F"),
            ("BtnImport", "希望を取り込む", "548235", "375623"),
    ...
    for i, ((r1, r1o, r2, r2o), (macro, text, fill, line)) in enumerate(zip(rows, spec)):
        btns.append(BTN_TMPL.format(
            c1=4, c1o=3305175, r1=r1, r1o=r1o,
...
def main():
    ...
    if "xl/activeX/activeX1.xml" not in files:
